...
const navigationMenuTriggerStyle = cva(
  "group inline-flex justify-center items-center gap-4 bg-background data-[active]:bg-accent/50 data-[state=open]:bg-accent/50 hover:bg-accent focus:bg-accent disabled:opacity-50 m-3 px-4 py-2 rounded-md focus:outline-none w-max h-9 font-medium text-sm transition-colors hover:text-accent-foreground focus:text-accent-foreground disabled:pointer-events-none"
)
